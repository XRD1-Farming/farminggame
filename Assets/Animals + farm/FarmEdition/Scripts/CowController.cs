...
namespace EasyPrimitiveAnimals
{
    public class CowController : MonoBehaviour
    {
        ...
        private void Start()
        {
            if (!this.gameObject.CompareTag("Cow")) return;
        ...
        private void Update()
        {
            if (!this.gameObject.CompareTag("Cow")) return; // If animal the script is attached to is not a chicken, animate 4 legs and body.
