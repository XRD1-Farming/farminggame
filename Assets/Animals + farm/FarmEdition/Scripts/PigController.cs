...
namespace EasyPrimitiveAnimals
{
    public class PigController : MonoBehaviour
    {
        ...
        private void Start()
        {
            if (!this.gameObject.CompareTag("Pig")) return;
        ...
        private void Update()
        {
            if (!this.gameObject.CompareTag("Pig")) return; // If animal the script is attached to is not a chicken, animate 4 legs and body.
